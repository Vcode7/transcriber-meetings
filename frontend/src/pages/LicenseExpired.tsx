...
export default function LicenseExpired({ message }: LicenseExpiredProps) {
  const displayMessage =
    message ||
    'This application license expired on 7 August 2026. Please contact the administrator for a renewed version.'
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: '0.83rem', color: 'hsl(220 10% 55%)' }}>
              License expired on{' '}
              <strong style={{ color: 'hsl(0 5% 85%)' }}>7 August 2026</strong>
            </span>
          </div>
